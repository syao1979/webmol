let borderLayout = function (root, onStateChanged) {
    let dragging;
    let area = {
    ...
    root.addEventListener('mousemove', function (e) {
        if (dragging) {
            let target = area[dragging.target];
